...
export const zh: Dict = {
  ...
  "cmd.noCli":
    "未找到 Claude CLI。请在终端中运行 <code>claude login</code>，然后重启 Lume。",
  "cmd.cancel": "取消",
  ...
  "blocks.helpKeys":
    '单击 → 滚动到终端中的提示符。<br/>右键单击 → 复制、插入、解释。<br/><kbd>Ctrl</kbd>+<kbd>↑</kbd>/<kbd>↓</kbd> → 导航，<kbd>↩</kbd> 插入到终端。<br/><span style="color: var(--accent)">✨</span> → Claude 解释。',
  ...
  "blocks.aiNoCli": "未找到 Claude CLI（claude login）",
  "blocks.aiBlockNotDone": "区块必须已完成",
  "blocks.aiNoCommand": "没有可解释的命令",
  "blocks.cancel": "取消",
  "blocks.aiFixError": "用 Claude 修复此错误",
  "blocks.aiExplainBlock": "用 Claude 解释此区块",
  "blocks.insertTerminal": "插入到终端",
  "blocks.gotoCommand": "跳转到终端中的命令",
  "blocks.explainClaude": "✨ 用 Claude 解释",
  "blocks.closeAiPanel": "关闭 Claude 面板",
