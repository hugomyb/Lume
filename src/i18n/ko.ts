...
export const ko: Dict = {
  ...
  "cmd.noCli":
    "Claude CLI를 찾을 수 없습니다. 터미널에서 <code>claude login</code>을 실행한 다음 Lume을 다시 시작하세요.",
  "cmd.cancel": "취소",
  ...
  "blocks.aiThinking": "Claude이 생각 중…",
  "blocks.aiError": "오류",
  "blocks.aiClose": "닫기",
  ...
  "blocks.helpKeys":
    '클릭 → 터미널의 프롬프트로 스크롤.<br/>오른쪽 클릭 → 복사, 삽입, 설명.<br/><kbd>Ctrl</kbd>+<kbd>↑</kbd>/<kbd>↓</kbd> → 이동, 터미널에 삽입하려면 <kbd>↩</kbd>.<br/><span style="color: var(--accent)">✨</span> → Claude 설명.',
  ...
  "blocks.aiNoCli": "Claude CLI를 찾을 수 없습니다 (claude login)",
  "blocks.aiBlockNotDone": "블록이 완료되어야 합니다",
  "blocks.aiNoCommand": "설명할 명령이 없습니다",
  "blocks.cancel": "취소",
  "blocks.aiFixError": "Claude으로 이 오류 고치기",
  "blocks.aiExplainBlock": "Claude으로 이 블록 설명하기",
  "blocks.insertTerminal": "터미널에 삽입",
  "blocks.gotoCommand": "터미널의 명령으로 이동",
  "blocks.explainClaude": "✨ Claude으로 설명",
  "blocks.closeAiPanel": "Claude 패널 닫기",
