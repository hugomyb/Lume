...
export const de: Dict = {
  ...
  "cmd.noCli":
    "Claude CLI nicht gefunden. Führe <code>claude login</code> in einem Terminal aus und starte Lume neu.",
  ...
  "blocks.aiThinking": "Claude denkt nach…",
  ...
  "blocks.helpKeys":
    'Klick → zum Prompt im Terminal scrollen.<br/>Rechtsklick → kopieren, einfügen, erklären.<br/><kbd>Ctrl</kbd>+<kbd>↑</kbd>/<kbd>↓</kbd> → navigieren, <kbd>↩</kbd> zum Einfügen ins Terminal.<br/><span style="color: var(--accent)">✨</span> → Claude-Erklärung.',
  ...
  "blocks.aiNoCli": "Claude CLI nicht gefunden (claude login)",
  ...
  "blocks.aiFixError": "Diesen Fehler mit Claude beheben",
  "blocks.aiExplainBlock": "Diesen Block mit Claude erklären",
  "blocks.insertTerminal": "Ins Terminal einfügen",
  "blocks.gotoCommand": "Zum Befehl im Terminal springen",
  "blocks.explainClaude": "✨ Mit Claude erklären",
  "blocks.closeAiPanel": "Claude-Panel schließen",
