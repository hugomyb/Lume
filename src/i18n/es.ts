...
export const es: Dict = {
  ...
  "cmd.noCli":
    "No se encontró Claude CLI. Ejecuta <code>claude login</code> en una terminal y reinicia Lume.",
  "cmd.cancel": "Cancelar",
  ...
  "blocks.aiThinking": "Claude está pensando…",
  ...
  "blocks.helpKeys":
    'Clic → desplazarse al prompt en la terminal.<br/>Clic derecho → copiar, insertar, explicar.<br/><kbd>Ctrl</kbd>+<kbd>↑</kbd>/<kbd>↓</kbd> → navegar, <kbd>↩</kbd> para insertar en la terminal.<br/><span style="color: var(--accent)">✨</span> → explicación de Claude.',
  ...
  "blocks.aiNoCli": "No se encontró Claude CLI (claude login)",
  ...
  "blocks.aiFixError": "Corregir este error con Claude",
  "blocks.aiExplainBlock": "Explicar este bloque con Claude",
  "blocks.insertTerminal": "Insertar en la terminal",
  "blocks.gotoCommand": "Ir al comando en la terminal",
  "blocks.explainClaude": "✨ Explicar con Claude",
  "blocks.closeAiPanel": "Cerrar el panel de Claude",
