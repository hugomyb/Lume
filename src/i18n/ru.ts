...
export const ru: Dict = {
  ...
  "remote.lanClear": "LAN-ссылка использует незашифрованный HTTP: в ненадёжной сети всё введённое и отображаемое может быть перехвачено — предпочтите интернет-туннель.",
