...
export const ar: Dict = {
  ...
  "cmd.noCli":
    "<code>{cmd}</code> غير موجود في PATH — اضبط مزوّدًا من الإعدادات › الذكاء الاصطناعي.",
  "cmd.noProvider":
    "لا يوجد مزوّد ذكاء اصطناعي مُهيّأ — اضبط واحدًا من الإعدادات › الذكاء الاصطناعي.",
  "cmd.cancel": "إلغاء",
  ...
  "blocks.aiThinking": "{provider} يفكّر…",
  "blocks.aiError": "خطأ",
  ...
  "blocks.helpKeys":
    'نقر ← التمرير إلى الموجِّه في الطرفي.<br/>نقر يمين ← نسخ، إدراج، شرح.<br/><kbd>Ctrl</kbd>+<kbd>↑</kbd>/<kbd>↓</kbd> ← للتنقل، <kbd>↩</kbd> للإدراج في الطرفي.<br/><span style="color: var(--accent)">✨</span> ← شرح الذكاء الاصطناعي.',
  ...
  "blocks.cancel": "إلغاء",
  "blocks.aiFixError": "أصلح هذا الخطأ باستخدام {provider}",
  ...
  "ai.command": "الأمر",
  "ai.args": "الوسائط",
  "ai.keyEnv": "متغيّر البيئة لمفتاح API",
  "ai.claudeNote": "يستخدم واجهة <code>claude</code> CLI (Claude Code). شغّل <code>claude login</code> مرة واحدة للمصادقة.",
  "ai.codexNote": "يستخدم واجهة <code>codex</code> CLI (OpenAI). صادِق باستخدام <code>codex login</code>، أو عيّن مفتاح API أعلاه (يُحقن كـ <code>OPENAI_API_KEY</code>).",
  "ai.customNote": "أي واجهة CLI تتلقى prompt وتطبع الإجابة على stdout. ضع <code>{prompt}</code> في الوسائط حيث يجب أن يذهب prompt.",
