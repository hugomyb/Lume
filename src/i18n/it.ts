...
export const it: Dict = {
  ...
  "cmd.noCli":
    "Claude CLI non trovato. Esegui <code>claude login</code> in un terminale poi riavvia Lume.",
  "cmd.cancel": "Annulla",
  ...
  "blocks.aiThinking": "Claude sta pensando…",
  ...
  "blocks.helpKeys":
    'Clic → scorri fino al prompt nel terminale.<br/>Clic destro → copia, inserisci, spiega.<br/><kbd>Ctrl</kbd>+<kbd>↑</kbd>/<kbd>↓</kbd> → naviga, <kbd>↩</kbd> per inserire nel terminale.<br/><span style="color: var(--accent)">✨</span> → spiegazione di Claude.',
  ...
  "blocks.aiNoCli": "Claude CLI non trovato (claude login)",
  "blocks.aiBlockNotDone": "Il blocco deve essere completato",
  "blocks.aiNoCommand": "Nessun comando da spiegare",
  "blocks.cancel": "Annulla",
  "blocks.aiFixError": "Correggi questo errore con Claude",
  "blocks.aiExplainBlock": "Spiega questo blocco con Claude",
  "blocks.insertTerminal": "Inserisci nel terminale",
  "blocks.gotoCommand": "Vai al comando nel terminale",
  "blocks.explainClaude": "✨ Spiega con Claude",
  "blocks.closeAiPanel": "Chiudi il pannello di Claude",
