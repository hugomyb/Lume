...
export const nl: Dict = {
  ...
  "cmd.noCli":
    "Claude CLI niet gevonden. Voer <code>claude login</code> uit in een terminal en herstart Lume.",
  ...
  "blocks.aiThinking": "Claude denkt na…",
  "blocks.aiError": "Fout",
  ...
  "blocks.helpKeys":
    'Klik → scroll naar de prompt in de terminal.<br/>Rechtsklik → kopiëren, invoegen, uitleggen.<br/><kbd>Ctrl</kbd>+<kbd>↑</kbd>/<kbd>↓</kbd> → navigeren, <kbd>↩</kbd> om in te voegen in de terminal.<br/><span style="color: var(--accent)">✨</span> → uitleg van Claude.',
  ...
  "blocks.aiNoCli": "Claude CLI niet gevonden (claude login)",
  ...
  "blocks.aiFixError": "Deze fout oplossen met Claude",
  "blocks.aiExplainBlock": "Dit blok uitleggen met Claude",
  "blocks.insertTerminal": "Invoegen in de terminal",
  "blocks.gotoCommand": "Naar het commando in de terminal gaan",
  "blocks.explainClaude": "✨ Uitleggen met Claude",
  "blocks.closeAiPanel": "Het Claude-paneel sluiten",
