...
export const pt: Dict = {
  ...
  "cmd.noCli":
    "Claude CLI não encontrado. Execute <code>claude login</code> em um terminal e reinicie o Lume.",
  "cmd.cancel": "Cancelar",
  ...
  "blocks.helpKeys":
    'Clique → role até o prompt no terminal.<br/>Clique direito → copiar, inserir, explicar.<br/><kbd>Ctrl</kbd>+<kbd>↑</kbd>/<kbd>↓</kbd> → navegar, <kbd>↩</kbd> para inserir no terminal.<br/><span style="color: var(--accent)">✨</span> → explicação do Claude.',
  ...
  "blocks.aiNoCli": "Claude CLI não encontrado (claude login)",
  ...
  "blocks.aiFixError": "Corrigir este erro com o Claude",
  "blocks.aiExplainBlock": "Explicar este bloco com o Claude",
  "blocks.insertTerminal": "Inserir no terminal",
  "blocks.gotoCommand": "Ir para o comando no terminal",
  "blocks.explainClaude": "✨ Explicar com o Claude",
  "blocks.closeAiPanel": "Fechar o painel do Claude",
