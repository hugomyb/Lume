...
export const hi: Dict = {
  ...
  "remote.lanClear": "LAN लिंक अनएन्क्रिप्टेड HTTP है: अविश्वसनीय नेटवर्क पर टाइप या प्रदर्शित सब कुछ इंटरसेप्ट किया जा सकता है — इंटरनेट टनल को प्राथमिकता दें।",
