...
export const hi: Dict = {
  ...
  "cmd.noCli":
    "Claude CLI नहीं मिला। किसी टर्मिनल में <code>claude login</code> चलाएँ, फिर Lume पुनः आरंभ करें।",
  ...
  "blocks.aiThinking": "Claude सोच रहा है…",
  ...
  "blocks.helpKeys":
    'क्लिक → टर्मिनल में प्रॉम्प्ट तक स्क्रॉल करें।<br/>राइट-क्लिक → कॉपी, डालें, समझाएँ।<br/><kbd>Ctrl</kbd>+<kbd>↑</kbd>/<kbd>↓</kbd> → नेविगेट करें, टर्मिनल में डालने के लिए <kbd>↩</kbd>।<br/><span style="color: var(--accent)">✨</span> → Claude व्याख्या।',
  ...
  "blocks.aiNoCli": "Claude CLI नहीं मिला (claude login)",
  "blocks.aiBlockNotDone": "ब्लॉक पूर्ण होना चाहिए",
  "blocks.aiNoCommand": "समझाने के लिए कोई कमांड नहीं",
  "blocks.cancel": "रद्द करें",
  "blocks.aiFixError": "Claude से यह त्रुटि ठीक करें",
  "blocks.aiExplainBlock": "Claude से यह ब्लॉक समझाएँ",
  "blocks.insertTerminal": "टर्मिनल में डालें",
  "blocks.gotoCommand": "टर्मिनल में कमांड पर जाएँ",
  "blocks.explainClaude": "✨ Claude से समझाएँ",
  "blocks.closeAiPanel": "Claude पैनल बंद करें",
